...
moduleForModel('i-i-s-async-open-xml-reports-sample-brand', 'Unit | Serializer | i-i-s-async-open-xml-reports-sample-brand', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-async-open-xml-reports-sample-brand',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
