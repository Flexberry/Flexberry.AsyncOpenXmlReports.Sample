...
moduleForAcceptance('[AGAT] Acceptance | i i s async open xml reports sample car l');

test('testing i-i-s-async-open-xml-reports-sample-car-l', function(assert) {
  visit('/i-i-s-async-open-xml-reports-sample-car-l');
