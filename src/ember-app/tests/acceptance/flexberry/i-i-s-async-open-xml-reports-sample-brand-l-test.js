...
moduleForAcceptance('[AGAT] Acceptance | i i s async open xml reports sample brand l');

test('testing i-i-s-async-open-xml-reports-sample-brand-l', function(assert) {
  visit('/i-i-s-async-open-xml-reports-sample-brand-l');
