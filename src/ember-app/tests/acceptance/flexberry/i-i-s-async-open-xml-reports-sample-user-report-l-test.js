...
moduleForAcceptance('[AGAT] Acceptance | i i s async open xml reports sample user report l');

test('testing i-i-s-async-open-xml-reports-sample-user-report-l', function(assert) {
  visit('/i-i-s-async-open-xml-reports-sample-user-report-l');
